...
#define IFXOS_CRLF                              "\n"
   ...
   /** Kernel - Debug Print on Int-Level (formatted) */
#define IFXOS_DBG_PRINT_INT(fmt, args...)       printk(KERN_DEBUG fmt, ##args)
   /** Kernel - Debug Print on Appl-Level (formatted) */
#define IFXOS_DBG_PRINT_USR(fmt, args...)       printk(KERN_DEBUG fmt, ##args)

   /** Kernel - Error Print on Int-Level (formatted) */
#define IFXOS_ERR_PRINT_INT(fmt, args...)       printk(KERN_DEBUG fmt, ##args)
   /** Kernel - Error Print on Appl-Level (formatted) */
#define IFXOS_ERR_PRINT_USR(fmt, args...)       printk(KERN_DEBUG fmt, ##args)


   /** Kernel - Print on Int-Level (unformatted) */
#define IFXOS_PRINT_INT_RAW(fmt, args...)       printk(KERN_DEFAULT fmt, ##args)
   /** Kernel - Print on Appl-Level (unformatted) */
#define IFXOS_PRINT_USR_RAW(fmt, args...)       printk(KERN_DEFAULT fmt, ##args)
